...
async function main() {
  ...
  console.log(
    `deploying operator, owner is ${ownerAddress} , linkTokenAddress is ${linkTokenAddress} to ${network.name}`
  );
  ...
  console.log(
    `operator deployed on ${network.name}, contract address is ${operator.address} `
  );
}
